...
- [ ] Explain what a token is used for.
    A token is used to protect resources that require authentication.
- [ ] What steps can you take in your web apps to keep your data secure?
     A web app can have more secure data by creating protected routes that require a token in order to gain access.
- [ ] Describe how web servers work.
    A server is a system/computer that provides a variety of things (such as data, programs, etc) over a network to “clients”
    , aka other computers. The client will make a request for data to the server, and the server will return the data.
